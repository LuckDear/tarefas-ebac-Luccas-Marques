...
import anotacao.Generic.IGenericDAO;
import anotacao.dao.ClienteMapDAO;
import anotacao.dao.IClienteDAO;
import anotacao.dao.IProdutoDAO;
import anotacao.dao.ProdutoDAO;
import anotacao.exception.DadosInvalidosException;
import anotacao.exception.TipoExceptionNaoEncontrada;
import anotacao.fabrica.FabricaPersistente;
import anotacao.fabrica.Factory;
import anotacao.fabrica.IFactory;
...
public class App2 {
    ...
    private static void executarOpcaoAtualizar(String opcaoMenuGeral) {
        ...
        } catch (TipoExceptionNaoEncontrada e) {
    ...
    public static IGenericDAO getDAO(String opcaoMenuGeral) {
        if ("1".equals(opcaoMenuGeral)) {
            ...
            return (IGenericDAO) iProdutoDAO;
        }
    }
     ...
     * @return
     */
    private static Boolean cadastrarObjeto(String opcaoMenuGeral, Persistente persistente) throws TipoExceptionNaoEncontrada {
